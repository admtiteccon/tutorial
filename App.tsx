            ...
            {activeTab === 'intro' && (
              <div className="space-y-8 print:space-y-4">
                <div className="text-center py-12 bg-white/60 backdrop-blur-xl rounded-3xl border border-white/50 shadow-xl relative overflow-hidden print:shadow-none print:border-none print:bg-white">
                   ...
                   <h1 className="text-4xl sm:text-5xl font-black text-slate-900 mb-4 tracking-tight">Sistema TECCON</h1>
            ...
            {activeTab === 'notebook' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <StepCard 
                  ...
                  note="Use um adaptador USB/Wi-Fi se necessário para garantir estabilidade."
                >
                  <p>Após ligar a TV, se precisar de acesso à internet, procure pela rede Wi-Fi:</p>
                  <p className="mt-3 font-mono bg-slate-100 inline-block px-3 py-1.5 rounded-lg border border-slate-200 text-slate-700 font-bold tracking-wide">
                    TRN-WIFI
                  </p>
                </StepCard>

                <StepCard badge="2️⃣" title="PROJETAR TELA">
                  <p>No seu notebook (Windows), pressione as teclas <strong>Windows + K</strong> para abrir o menu de conexão.</p>
                  <p className="mt-2">Selecione o display correspondente à sala na lista de dispositivos disponíveis.</p>
                </StepCard>
                ...
                <StepCard badge="3️⃣" title="OPÇÃO VIA CABO" note="O cabo HDMI geralmente fica disponível na mesa.">
                  ...
                  <p className="mt-2">Use o controle remoto da TV para selecionar a entrada <strong>HDMI</strong> correta.</p>
                </StepCard>
              </div>
            )}
